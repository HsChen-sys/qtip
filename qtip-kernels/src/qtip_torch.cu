...
__host__ extern void decompress_matvec_16_9_4_1_4096_1_12288(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 4096U, 1U, 12288U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_4096_1_1024(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 4096U, 1U, 1024U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_4_1_2048_1_3072(
    ...
    decompress_matvec<16U, 9U, 4U, 1U, 2048U, 1U, 3072U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_1024_1_1024(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 1024U, 1U, 1024U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_1024_1_2048(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 1024U, 1U, 2048U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_2048_1_1024(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 2048U, 1U, 1024U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_6144_1_2048(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 6144U, 1U, 2048U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_2048_1_6144(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 2048U, 1U, 6144U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_4_1_2048_1_2048(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 2048U, 1U, 2048U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_5120_1_13824(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 5120U, 1U, 13824U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_4_1_13824_1_5120(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 13824U, 1U, 5120U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_5120_1_5120(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 5120U, 1U, 5120U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_2_1_53248_1_16384(
    ...
    decompress_matvec<16U, 9U, 2U, 1U, 53248U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_53248_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 53248U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_53248_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 53248U, 1U, 16384U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_2_1_16384_1_53248(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 16384U, 1U, 53248U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_16384_1_53248(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 16384U, 1U, 53248U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_16384_1_53248(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 16384U, 1U, 53248U>(out, compressed, x, codebook);
}
...
__host__ extern void decompress_matvec_16_9_2_1_1024_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 1024U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_1024_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 1024U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_1024_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 1024U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_2_1_16384_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 16384U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_16384_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 16384U, 1U, 16384U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_16384_1_16384(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 16384U, 1U, 16384U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_2_1_4096_1_14336(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 4096U, 1U, 14336U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_4096_1_14336(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 4096U, 1U, 14336U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_4096_1_14336(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 4096U, 1U, 14336U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_2_1_14336_1_4096(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 14336U, 1U, 4096U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_14336_1_4096(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 14336U, 1U, 4096U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_14336_1_4096(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 14336U, 1U, 4096U>(out, compressed, x, codebook);
}


__host__ extern void decompress_matvec_16_9_2_1_1024_1_4096(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 2U, 1U, 1024U, 1U, 4096U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_3_1_1024_1_4096(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 3U, 1U, 1024U, 1U, 4096U>(out, compressed, x, codebook);
}

__host__ extern void decompress_matvec_16_9_4_1_1024_1_4096(
        torch::Tensor &out,
        torch::Tensor &compressed,
        torch::Tensor &x,
        torch::Tensor &codebook
) {
    decompress_matvec<16U, 9U, 4U, 1U, 1024U, 1U, 4096U>(out, compressed, x, codebook);
}
